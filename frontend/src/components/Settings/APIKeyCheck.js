...
const APIKeyCheck = ({ onAPIKeyVerified }) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-200">Checking your settings...</p>
        </div>
      </div>
    )
  }
  ...
  if (hasApiKey && !showSettings) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black">
        <div className="bg-white dark:bg-black rounded-lg shadow-lg p-8 max-w-md mx-auto text-center">
          <div className="w-16 h-16 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
            <Key className="w-8 h-8 text-green-600 dark:text-green-400" />
          </div>
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Ready to Go!</h2>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-black py-8">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-200 mb-2">Setup Your API Key</h1>
            <p className="text-gray-600 dark:text-gray-200">Configure your Groq API key to start querying your data</p>
          </div>
          <APIKeySettings />
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-black">
      <div className="bg-white dark:bg-black rounded-lg shadow-lg p-8 max-w-md mx-auto text-center">
        ...
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">API Key Required</h2>
        <p className="text-gray-600 dark:text-gray-200 mb-6">
