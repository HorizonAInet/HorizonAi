        ...
        className={`
          ...
          ${
            isDragActive
              ...
              : "border-gray-600 dark:border-gray-500 hover:border-gray-500 dark:hover:border-gray-300"
          }
      ...
      >
        ...
        {uploading ? (
          ...
          <div className="space-y-4">
            ...
            <div>
              <p className="text-lg font-normaltext text-gray-500 dark:text-gray-200">
                {isDragActive
                  ? "Drop your file here"
          ...
          <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              ...
              <button
                ...
                className="flex items-center space-x-2 bg-github-dark text-white px-4 py-2 rounded-lg hover:bg-black transition-colors font-normaltext"
              >
                <Code size={16} />
                <span>
