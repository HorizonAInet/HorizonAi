  ...
  if (transformedQueries.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-normaltext text-black dark:text-white mb-2">
          No Query History
        </h3>
        <p className="text-gray-500 dark:text-gray-400 font-normaltext">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="bg-white dark:bg-github-dark border border-gray-300 dark:border-black rounded px-3 py-1 text-gray-700 dark:text-gray-200 text-sm shadow-sm focus:outline-none focus:ring-0 focus:ring-logocolor"
            >
        ...
        <button
          ...
          className="flex items-center space-x-2 bg-gray-100 dark:bg-github-dark hover:bg-gray-200 dark:hover:bg-black text-gray-900 dark:text-white px-4 py-2 rounded-lg transition-colors"
        >
          <Download size={16} />
      ...
      <div className="space-y-4">
        {sortedFileNames.map((fileName) => {
          ...
          return (
            <div
              key={fileName}
              className="bg-white dark:bg-github-dark rounded-lg border border-gray-200 dark:border-black shadow-sm"
            >
              <div
                className="flex items-center justify-between p-4 cursor-pointer hover:bg-gray-100 dark:hover:bg-black transition-colors"
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-gray-900 dark:text-white font-normaltext font-medium">
                      {fileName}
                    </h3>
                ...
                <div className="text-gray-400 dark:text-gray-500">{fileQueries.length}</div>
              </div>

              {isExpanded && (
                <div className="border-t border-gray-200 dark:border-black bg-gray-100 dark:bg-black">
                  {fileQueries
                    .sort(
                    ...
                    .map((query, index) => (
                      ...
                      >
                        {/* Query Header */}
                        <div
                          className="p-4 cursor-pointer hover:bg-white dark:hover:bg-gray-700 transition-colors"
                          onClick={() =>
                            setSelectedQuery(
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              <div className="flex items-center space-x-2 mb-2">
                                ...
                                <h4 className="text-gray-900 dark:text-white font-normaltext text-sm truncate">
                                  {query.query}
                                </h4>
                              </div>

                              <div className="flex items-center space-x-4 text-xs text-gray-500 dark:text-gray-200">
                        ...
                        {selectedQuery === query.id && (
                          <div className="border-t border-gray-200 dark:border-black bg-white dark:bg-github-dark">
                            {/* Error Message */}
                            {query.error && (
                                            ...
                                            .map((row, rowIndex) => (
                                              ...
                                              >
                                                {row.map((cell, cellIndex) => (
                                                  <td
                                                    key={cellIndex}
                                                    className="py-2 px-3 text-gray-600 dark:text-gray-200 font-normaltext text-xs"
                                                  >
                                                    {cell === null ||
                                                    cell === undefined ||
                                                    cell === "nan" ||
                                          ...
                                          {query.result.data.map(
                                            (value, index) => (
                                              <tr
                                                ...
                                                className="border-b border-gray-100 hover:bg-gray-50"
                                              >
                                                <td className="py-2 px-3 text-gray-600 dark:text-gray-200 font-normaltext text-xs font-medium">
                                                  {query.result.index[index] ||
                                                    index}
                                                </td>
                                                <td className="py-2 px-3 text-gray-600 dark:text-gray-200 font-normaltext text-xs">
                                                  {value === null ||
                                                  value === undefined ||
                                                  value === "nan" ||
                                                  (typeof value === "number" &&
      ...
      {sortedFileNames.length === 0 && (
        <div className="text-center py-8">
          <p className="text-gray-900 dark:text-white font-normaltext">
            {filter === "all"
